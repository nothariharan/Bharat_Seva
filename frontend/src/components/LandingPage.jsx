...
const LandingPage = ({
  ...
  const labels = {
    ...
    "bn-IN": { title: "ভারত সেবা", hero: "মাইক টিপুন এবং আপনার সমস্যার কথা বলুন", subtitle: "আমি আপনার ভাষায় ধাপে ধাপে আপনাকে গাইড করব।", processing: "ভাবছি...", readNotice: "আমার জন্য একটি চিঠি পড়ুন", suggestions: ["আমার বিধবা ভাতা বন্ধ হয়ে গেছে", "আবাস যোজনার জন্য কীভাবে আবেদন করব?", "নিকটবর্তী BDO অফিস খুঁজুন"], orgLogin: "সংস্থা লগইন" },
  ...
  return (
    <div
      className="flex min-h-[100dvh] relative overflow-hidden bg-orange-50/70"
      style={{
    ...
    >
      ...
      <NavSidebar
        ...
        onToggleSecondary={handleTogglePanel}
        isOpen={isPanelOpen}
      />

      {/* Secondary Content Panel */}
      <div className={`hidden lg:flex shrink-0 h-screen sticky top-0 transition-all duration-500 ease-in-out z-40 bg-white/40 backdrop-blur-md shadow-2xl border-r border-orange-100 overflow-hidden ${isPanelOpen ? 'w-96 opacity-100 translate-x-0' : 'w-0 opacity-0 -translate-x-full border-none'}`}>
      ...
      <div className="flex-1 flex flex-col relative">
        ...
        {/* Top Navigation Bar */}
        <header className="w-full p-6 flex justify-between items-center z-40">
          <div className="flex items-center gap-2 lg:hidden">
            <LayoutGrid className="text-orange-500" />
            <span className="font-bold text-gray-800">Bharat Seva</span>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="bg-orange-500 hover:bg-orange-600 text-white font-bold py-2.5 px-6 rounded-2xl shadow-lg shadow-orange-100 transition-all active:scale-95"
            >
              {t.orgLogin}
            </button>
          </div>
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-4 py-8">
          <div className="w-full max-w-2xl flex flex-col items-center text-center z-10">
            <h1
              className="text-5xl md:text-7xl font-normal text-gray-900 tracking-tight mb-6 select-none"
              style={{
                fontFamily: 'Samarkan',
            ...
            <p className="text-xl md:text-3xl font-extrabold text-orange-600 mb-2 bg-white/60 px-6 py-2 rounded-3xl backdrop-blur-sm shadow-sm inline-block">
              {t.hero}
            </p>
            <p className="text-base md:text-xl text-gray-700 font-bold mb-8 mt-2 bg-white/50 backdrop-blur px-4 py-2 rounded-2xl">
              {t.subtitle}
            </p>

            {transcript && !loading && (
              <div className="w-full max-w-md bg-white/95 backdrop-blur-md p-6 rounded-3xl shadow-xl border-l-8 border-orange-500 mb-10 animate-fade-in text-left">
                <p className="font-extrabold text-gray-800 text-xl italic leading-relaxed text-center">"{transcript}"</p>
              </div>
            )}

            {loading ? (
              <div className="my-8 flex flex-col items-center justify-center animate-fade-in bg-white/90 p-10 rounded-3xl backdrop-blur-md shadow-2xl border border-orange-50">
                <div className="flex gap-3 mb-6">
                  ...
                  <div className="w-4 h-4 rounded-full bg-orange-500 animate-bounce" style={{ animationDelay: '300ms' }}></div>
                </div>
                <p className="font-extrabold text-orange-900 text-2xl tracking-tight">{t.processing}</p>
              </div>
            ) : (
              <div className="my-6">
